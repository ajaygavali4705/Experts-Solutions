...
//           We're Here to Assist You Connect With Expert Solutions
//         </h1>
...
//       <center><h3 className="text-xl font-extrabold  tracking-wide mb-4">SALES & BUSINESS ENQUIRIES</h3></center>
...
//   return (
//     <section id="tax" className="w-full bg-light-gray-200 py-12 px-2">
//       <div className="max-w-7xl mx-auto space-y-10">
//         <div className="rounded-3xl bg-gray-200 p-6 shadow-2xl space-y-6">
...
//           <p className="text-xl font-semibold text-gray-800">🕒 Monday to Saturday</p>
//           <p className="text-gray-600 mt-1">10:00 AM – 7:00 PM</p>
//         </div>
//       </motion.div>
//     </section>
//   );
